...
class BookingServiceTests {
    ...
    void findBookingByIdTest() {
        Optional<BookingGetDto> bookingDto = Optional.of(bookingService.findBookingById(1L, 2L));
    ...
    void findBookingByIdWithBookingNotFoundExceptionTest() {
        assertThrows(BookingNotFoundException.class, () -> bookingService.findBookingById(10L, 1L));
    }
